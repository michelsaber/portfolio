  ...
  return (
    ...
    <div style={{backgroundColor :"#262f38"}}>
        ...
        <Image src={picture} rounded fluid style={{maxWidth:"30%", maxHeight:"30vw"}} className='px-4 m-5'/>
          ...
          <p className='text-white pt-2 px-5 fs-5'>I am a self-motivated Web Developer looking for a position where I can make an impact and continue learning.</p>
